"""
Django settings for medunigraz.mailman project.
...
MIDDLEWARE = [
    ...
    'medunigraz.mailman.middleware.MUGLocaleMiddleware',
]
...
ROOT_URLCONF = 'medunigraz.mailman.urls'
...
WSGI_APPLICATION = 'medunigraz.mailman.wsgi.application'
